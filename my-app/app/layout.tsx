...
// The root layout owns only the document shell — fonts, global stylesheet, and
// <html>/<body>. Anything chrome-like (nav, page gradient) belongs to a route
// group layout, so full-bleed routes such as /login can opt out of it entirely.
